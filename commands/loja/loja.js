...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embedLoja = new EmbedBuilder()
            ...
            .addFields(
                { name: '🎨 Tinturas Padrão', value: 'Custa: **8.000 Ouro** (cada)\nOpções: Carmesim, Esmeralda ou Abissal.' },
                { name: '🖌️ Cor Personalizada', value: 'Custa: **10.000 Ouro**\nEscolha o código Hexadecimal exato da sua cor.' },
                { name: '🎟️ Passe VIP', value: 'Custa: **10.000 Ouro**\nCargo exclusivo, cor destacada e Emojis externos.' },
                { name: '🗝️ Acesso ao Porão', value: 'Custa: **15.000 Ouro**\nAcesso aos canais secretos e logs da administração.' },
                { name: '👑 Título de Nobreza', value: 'Custa: **20.000 Ouro**\nO auge da ostentação estética na guilda.' },
                { name: '🎲 Chave Aleatória Steam', value: 'Custa: **22.000 Ouro**\nUma key real de um jogo surpresa.' },
                ...
                { name: '🚀 Discord Nitro (1 Mês)', value: 'Custa: **90.000 Ouro**\nO prêmio máximo da Taverna!' }
            )
